  ...
  return (
    <div className="flex-col">
      <footer className="font-sans bg-gray-100 text-center text-md absolute bottom-0 w-full p-6 shadow-inner">
        &copy; 2020 Designed and built by <a href="http://heyitschun.com" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-red-300">Chun Poon</a> 
          <div className="mt-3">
